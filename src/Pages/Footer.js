...
const Footer = () => {
    ...
    return (
        <div>
            ...
            <Line />
            <div >
                <p style={{ fontSize:'0.8vw', color: 'gray', opacity: .5 }}>حق نشر تمامی حقوق برای فروشگاه مقدم محفوظ می‌باشد و هرگونه کپی‌برداری مستلزم کسب اجازۀ کتبی بوده و پیگرد قانونی خواهد داشت.</p>
            </div>
        </div>
    );
}
